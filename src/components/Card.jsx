    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="relative z-20 h-full flex flex-col items-center justify-between p-4 text-amber-100">
            <div className="w-20 h-20 mt-4 bg-amber-400 rounded-full flex items-center justify-center border-4 border-amber-600 shadow-lg">
              <div className="text-4xl">{crestIcon || "⚡"}</div>
            </div>
        ...
        <div
          ...
          className="absolute w-full h-full rounded-xl overflow-hidden border-2 border-amber-400 shadow-xl bg-gradient-to-b from-amber-900 via-amber-800 to-amber-700 flex items-center justify-center p-4 text-amber-100 text-center"
        >
          <p className="text-lg leading-relaxed font-cormorant">{backText}</p>
        </div>
      </div>
    </div>
  );
